...
public class CajaPuntajeActual extends HBox {

    private Label puntajeLabel;
    private Balatro modelo;

    public CajaPuntajeActual(Balatro modelo, String colorTexto) {
        this.modelo = modelo;
        ...
        this.puntajeLabel = new Label(modelo.getRonda().getPuntajeActual().toString());
    ...
    public void actualizar() {
        puntajeLabel.setText(modelo.getRonda().getPuntajeActual().toString());
    }
}
